##### REMOVED STUFF HERE IS ALREADY IMPORTED TO CLIENT.PY #####
...
class Player(pygame.sprite.Sprite):
    ...
    def shoot(self):
        bullet = Bullet(self.rect.x, self.rect.centery, self.direction)
...
class Zombie(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.direction == "D":
            self.image = pygame.image.load('Images/ZombieW.png')
        if self.direction == "UR":
            self.image = pygame.image.load('Images/ZombieNE.png')
        if self.direction == "UL":
            self.image = pygame.image.load('Images/ZombieNW.png')
        if self.direction == "DR":
            self.image = pygame.image.load('Images/ZombieSE.png')
        if self.direction == "DL":
            self.image = pygame.image.load('Images/ZombieSW.png')
